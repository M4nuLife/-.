...
;(function(name, factory) {
  ...
  Factory.prototype = {
    ...
    init: function() {
      if (document.getElementById('ribbons-bg-canvas')) return

      try {
        this._canvas = document.createElement('canvas')
        this._canvas.id = 'ribbons-bg-canvas'
    ...
    addRibbon: function() {
      ...
      var ribbon = [],
        ...
        point3 = null,
        color = Math.round(random(this._options.colorHueMin, this._options.colorHueMax)),
        delay = 0
